  ...
  <div class="bg-[#14274A] flex flex-col">
    <div class="flex justify-around py-10">
      <div class="text-sm text-white">
        ...
        <div>(Tel) 0341 383-2007</div>
      </div>

      <br />
      <Boton texto="Contactanos"></Boton>
    </div>

    <hr />
    <div class="flex justify-around py-6">
      <div class="flex gap-2">
        <button class="text-white">Inicio</button>
        <button class="text-white">Servicios</button>
        <button class="text-white">Contactanos</button>
      </div>
      <br />
      <div class="flex gap-2">
        <svg
