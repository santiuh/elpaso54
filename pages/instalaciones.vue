<template>
  ...
  <div class="lg:mx-52">
    ...
    <p class="font-monse text-2xl text-center px-5 lg:px-0">
      El complejo cuenta con Jacuzzi, una pequeña sala de juegos para niños y
      nuestra terraza en la cual vas a disfrutar de una vista soñada, pileta y
      parrillero.
    </p>
  </div>
  ...
  <Foto
    modo="A"
    foto="images/cama_dentro.jpeg"
    pie="SERVICIO DE LIMPIEZA"
  ></Foto>
